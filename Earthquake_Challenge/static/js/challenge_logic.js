...
// Add a third tile layer for the background of the map.
...
let techtronicPlates = new L.LayerGroup();
...
let overlays = {
  ...
  "Techtronic Plates": techtronicPlates,
...
d3.json("https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json").then(function(data) {
  ...
  L.geoJson(data, {
    ...
    color: "red",
    weight: 5
  }).addTo(techtronicPlates);

  techtronicPlates.addTo(map);
  });
});